      ...
      <div className="player-main">
        ...
        <div className="player-info">
          <div className="player-song-info">
            <p className="player-song-name" tabIndex={0}>{currentSong.name}</p>
            <p className="player-artist-name" tabIndex={0}>{getArtistName()}</p>
            {isSecondary && <span className="version-badge">Secondary Version</span>}
          </div>
          ...
          {currentSong.secondary_file_path && (
            <button onClick={toggleVersion} className="button--small" aria-label="Toggle version">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M8 3v3a2 2 0 0 1-2 2H3m18 0V3a2 2 0 0 0-2-2h-3"/>
                <path d="M16 21v-3a2 2 0 0 0-2-2h-3m-8 0v3a2 2 0 0 0 2 2h3"/>
              </svg>
              Switch Version
            </button>
          )}
